...
int main(int argc, char **argv){
  ...
  //get Unix timestamp
  std::string name_file = "RPLidar"+std::to_string(std::time(0))+".bmp";
  write_bitmap(name_file,XSIZE,YSIZE);

  //clear our vector information
  _scan_data.clear();

  std::cout<<"Scan data put to image successfully! Name of the image is "<<name_file<<"."<<std::endl;
